        ...
        <>
            <div className={`flex fixed w-full justify-between items-center border-b border-b-sky-100 px-10 py-2 bg-sky-50/40 font-medium tracking-tight text-[17px] ${dm_sans.className} z-10`}>
                <div className="flex gap-10 justify-center items-center ">
                    <Link href="/home" className={`flex items-center ${playfair.className} font-semibold text-2xl`}>
                        PostVault
                    </Link>
                </div>
                <div>
                    <ul className="flex gap-10 items-center">
                        <button className="hover:cursor-pointer tracking-tighter text-sm bg-sky-800 text-white px-6 py-2 rounded-md" onClick={onPublish}>Publish</button>
