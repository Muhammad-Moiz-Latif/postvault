...
import type { PostSchemaType } from "../pages/EditPosts";

export async function EditPost(Data: PostSchemaType) {
    ...
    const response = await privateApi.put<CreatePostResponse>(`/api/post/edit/${Data.postId}`, formData, {
        headers: {
