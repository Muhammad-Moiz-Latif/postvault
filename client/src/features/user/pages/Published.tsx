...
export default function PublishedPosts() {
    ...
    const publishedPosts = posts.filter((post: MyPost) => post.status === "PUBLISHED");
    ...
    if (isLoading) {
        return (
            <div className="w-full h-screen flex flex-col items-center justify-center gap-3">
                ...
                <p className="text-sm text-muted-foreground font-sans">Loading your published stories...</p>
            </div>
        );
    }
        ...
        <main className="min-h-screen bg-background">
            ...
            <div className="border-b border-border/50 bg-gradient-to-b from-card to-background">
                <div className="max-w-5xl mx-auto px-6 py-6">
                    ...
                    <div>
                        <h1 className="text-4xl font-serif font-bold text-foreground mb-2">Published Stories</h1>
                        <p className="text-muted-foreground font-sans">
                            {publishedPosts.length} {publishedPosts.length === 1 ? 'story' : 'stories'} published
                        </p>
                    </div>
                </div>
            </div>
            ...
            <div className="max-w-5xl mx-auto px-6 py-12">
                {publishedPosts.length === 0 ? (
                    ...
                    <div className="space-y-4">
                        {publishedPosts.map((post: MyPost) => (
                            <div
                                onMouseEnter={() => {
                            ...
                            >
                                ...
                                <div className="flex justify-between items-start mb-4">
                                    ...
                                    <span className="px-3.5 py-1.5 text-xs rounded-full font-semibold bg-green-100 text-green-700 font-sans">
                                        Published
                                    </span>
                                </div>
                                ...
                                <div className="flex gap-3">
                                    <button
                                        ...
                                        className="flex-1 px-4 py-2.5 text-sm font-semibold font-sans bg-primary text-background rounded-full hover:shadow-lg transition-all"
                                    >
                                        Edit
                                    </button>
