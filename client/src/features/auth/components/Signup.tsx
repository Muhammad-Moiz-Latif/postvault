...
export const SignUp = ({ isLogin, setLogin }: { isLogin: boolean, setLogin: React.Dispatch<React.SetStateAction<boolean>> }) => {
    ...
    return (
        <div className="flex w-full h-screen p-3 justify-center items-center bg-background">
            ...
            <div className='w-full h-full flex flex-col justify-start pt-8 lg:pt-15 items-center relative overflow-y-auto lg:overflow-visible animate-slide-down'>
                ...
                <form onSubmit={handleSubmit(onSubmit)} className="w-full max-w-xs lg:max-w-md px-4 lg:px-0 animate-slide-down" style={{ animationDelay: '0.3s' }}>
                    ...
                    <div className="flex justify-center mb-1.5">
                        <label htmlFor="profile-picture" className="cursor-pointer">
                            <div className="size-16 lg:size-20 rounded-full bg-muted flex items-center justify-center overflow-hidden border-2 border-border hover:border-primary transition-all">
                                {previewUrl ? (
